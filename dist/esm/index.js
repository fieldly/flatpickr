...
function FlatpickrInstance(element, instanceConfig) {
    ...
    function createDay(className, date, dayNumber, i) {
        const dateIsEnabled = isEnabled(date, true), dayElement = createElement("span", "flatpickr-day " + className, ''), innerDayElement = createElement("span", '', date.getDate().toString());
